...
HD_PWD='/home/duyliontran/xilinx/zturn-driver/zturn-driver.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log zturn_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source zturn_wrapper.tcl -notrace
