...
HD_PWD='/home/duyliontran/xilinx/zturn-driver/zturn-driver.runs/zturn_pnq_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log zturn_pnq_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source zturn_pnq_0_1.tcl
