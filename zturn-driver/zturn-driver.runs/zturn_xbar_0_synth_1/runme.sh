...
HD_PWD='/home/duyliontran/xilinx/zturn-driver/zturn-driver.runs/zturn_xbar_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log zturn_xbar_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source zturn_xbar_0.tcl
