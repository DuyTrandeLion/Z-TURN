...
HD_PWD='/home/duyliontran/xilinx/zturn-driver/zturn-driver.runs/zturn_rst_ps7_0_145M_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log zturn_rst_ps7_0_145M_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source zturn_rst_ps7_0_145M_0.tcl
