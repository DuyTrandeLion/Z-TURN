...
HD_PWD='/home/duyliontran/xilinx/zturn-driver/zturn-driver.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log zturn_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source zturn_wrapper.tcl
